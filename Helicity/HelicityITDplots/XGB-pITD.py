...
Plotter.Plot.fill_between(*(loadData("pITD_XGB_band.txt")),
...
p44 = Plotter.plotLine(loadData("pITD_XGB_line.txt"), color="gray", linewidth=1.5, alpha=1.0, label=" legend");
#
...
Plotter.Plot.legend([(p4[-1], p44[0])], [ r' $\mathit{\Delta \mathfrak{M}_g(\omega)}$ (XGB)'], numpoints=1,prop={'size':12.0},loc= (0.55, 0.8))
