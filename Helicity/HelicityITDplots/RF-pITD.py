...
Plotter.Plot.fill_between(*(loadData("pITD_RF_band.txt")),
...
p4 = Plotter.Plot.fill(0,0,'c', alpha=0.55, linewidth=0)
...
p44 = Plotter.plotLine(loadData("pITD_RF_line.txt"), color="c", linewidth=1.5, alpha=1.0, label=" legend");
#
...
Plotter.Plot.legend([(p4[-1], p44[0])], [ r' $\mathit{\Delta \mathfrak{M}_g(\omega)}$ (RF)'], numpoints=1,prop={'size':12.0},loc= (0.55, 0.8))
