...
Plotter.Plot.set_ylabel(r'$\mathit{\Delta \mathcal{I}_g(\omega, \mu)}$', fontsize =18)
...
p44 = Plotter.plotLine(loadData("ITD_GB_line.txt"), color="g", linewidth=1.5, alpha=1.0, label=" legend");
#
...
Plotter.Plot.legend([(p4[-1], p44[0])], [ r' $\mathit{\Delta \mathcal{I}_g(\omega, \mu)}$ (GBT)'], numpoints=1,prop={'size':16.0},loc= (0.45, 0.8))
