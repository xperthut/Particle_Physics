...
p44 = Plotter.plotLine(loadData("ITD_RF_line.txt"), color="c", linewidth=1.5, alpha=1.0, label=" legend");
#
...
Plotter.Plot.legend([(p4[-1], p44[0])], [ r' $\mathit{\Delta \mathcal{I}_g(\omega, \mu)}$ (RF)'], numpoints=1,prop={'size':16.0},loc= (0.5, 0.8))
