...
Plotter.Plot.fill_between(*(loadData("NNPDFpol_data/data_NNPDF_ITD_band.txt")),
                          facecolor="crimson", alpha=0.55, linewidth=0)
Plotter.Plot.fill_between(*(loadData("ITD_XGB_band.txt")),
                          facecolor="gray", alpha=0.55, linewidth=0)
Plotter.Plot.fill_between(*(loadData("ITD_GB_band.txt")),
...
p4 = Plotter.Plot.fill(0,0,'crimson', alpha=0.4, linewidth=0)
p1 = Plotter.Plot.fill(0,0,'gray', alpha=0.4, linewidth=0)
p2 = Plotter.Plot.fill(0,0,'g', alpha=0.4, linewidth=0)
...
p22 = Plotter.plotLine(loadData("ITD_GB_line.txt"), color="g", linewidth=1.5, alpha=1.0, label=" legend");
...
Plotter.Plot.legend([(p3[-1], p33[0]), (p2[-1], p22[0]), (p1[-1], p11[0]), (p4[-1], p44[0]) ], [ r' RF', r' GBT', r' XGB', r' NNPDF'], numpoints=1,prop={'size':14.0},loc= (0.65, 0.62))
